<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="_02.TodoList.Todo" %>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:ListView ID="CategoriesList" runat="server"
                ...
                OnItemInserted="CategoriesList_ItemInserted" ItemType="_04.ToDoList.Data.Category"
            ...
            <asp:ListView ID="TodosListView" runat="server"
                ...
                InsertItemPosition="None"
                OnItemInserted="TodosListView_ItemInserted" ItemType="_04.ToDoList.Data.Todo"
                ...
                <InsertItemTemplate>
                    ...
                    <td>Text:
                        <asp:TextBox ID="TodoTextEditTb" runat="server" Text='<%#: BindItem.Content %>'></asp:TextBox>
                    </td>
                    <td>CategoryId:
