...
//main snake module
var snake = (function Snake(canvas, snakeLength, snakeSize) {
    ...
    function print() {
        for (var i = 0; i < this.snake.length - 1; i++) {
            this.snake[i].print(context, "#F6F92A");
        }

        this.snake[this.snake.length - 1].print(context, "#99C134");
    }
