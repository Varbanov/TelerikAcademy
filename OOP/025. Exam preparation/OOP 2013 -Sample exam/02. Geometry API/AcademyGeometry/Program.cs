...
namespace GeometryAPI
{
    ...
    public class OptimizedFigureController : FigureController
    {
        public OptimizedFigureController()
            : base()
        {
        }
        ...
        protected override void ExecuteFigureInstanceCommand(string[] splitCommand)
        {
            ...
            {
                case "area":
                    var currIAreaMeasurable = currentFigure as IAreaMeasurable;
                    if (currIAreaMeasurable != null)
                    {
                        Console.WriteLine("{0:0.00}", currIAreaMeasurable.GetArea());
                    }
                    else
                    {
                ...
                case "volume":
                    var currIVolumeMeasurable = currentFigure as IVolumeMeasurable;
                    if (currIVolumeMeasurable != null)
                    {
                        Console.WriteLine("{0:0.00}", currIVolumeMeasurable.GetVolume());
                    }
                    else
                    {
                        Console.WriteLine("undefined");
                ...
                case "normal":
                    var currIFlat = currentFigure as IFlat;
                    if (currIFlat != null)
                    {
                        Console.WriteLine("{0:0.00}", currIFlat.GetNormal().ToString());
                    }
                    else
                    {
                        Console.WriteLine("undefined");
    ...
    public class Cylinder : Figure, IAreaMeasurable, IVolumeMeasurable
    {
        ...
        {
            double topAndBottomArea = CalcTopAndBottomArea();
        ...
        private double CalcTopAndBottomArea()
        {
            double topAndBottomArea = 2 * (this.Radius * this.Radius * Math.PI);
            return topAndBottomArea;
        }

        public double GetVolume()
        {
            double bottomArea = Math.PI * this.Radius * this.Radius;
...
namespace AcademyGeometry
{
    class Program
    {
        ...
        {
            return new OptimizedFigureController();
        }
