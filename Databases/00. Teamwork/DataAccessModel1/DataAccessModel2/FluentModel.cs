...
namespace DataAccessModel2	
{
	public partial class FluentModel : OpenAccessContext, IFluentModelUnitOfWork
	{
        //Server=localhost; Port=3306; Database=mydb; Uid=root; Pwd=123qwe; pooling=true
        ...
        public IQueryable<Stefan> Stefan
        {
            get
            {
                return this.GetAll<Stefan>();
            }
        }
