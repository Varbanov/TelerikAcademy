namespace NewsExam.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<NewsDbContext>
    {
        ...
        {
            //PLEASE UNCOMMENT TO SEED ONCE AND THEN COMMENT AGAIN. I COULD NOT
            //RESOLVE IT, BUT IF YOU TRY TO SEED AGAIN, USER LOGIN AND REGISTER FAILS,
            //OTHERWISE IF SEED IS EXECUTED ONCE, EVERYTHING IS OK
