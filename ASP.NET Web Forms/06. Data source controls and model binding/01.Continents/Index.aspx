...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:ListBox ID="ContinentsListBox" runat="server"
            SelectMethod="ContinentListBox_GetData"
            OnSelectedIndexChanged="ContinentsListBox_SelectedIndexChanged"
            DataTextField="Name"
            DataValueField="Id"
        ...
        <asp:GridView ID="CountriesGridView" runat="server"
            ...
            AllowSorting="True" AutoPostBack="true" ViewStateMode="Enabled"
            ...
            EmptyDataText="No countries available in this category."
            ...
            <Columns>
                ...
                <asp:CommandField SelectText="View" ShowSelectButton="True" s />
            </Columns>
        </asp:GridView>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="3">
                                ...
                                <asp:LinkButton runat="server" ID="TownsButtonInsert" Text="Insert"></asp:LinkButton>
                            </td>
                        </tr>
                    </tbody>
                </table>
